...
namespace advanced_vod_functions_v3
{
    public static class CreateEmptyAsset
    {
            ...
            ILogger log)
        {
            ...
            Guid assetGuid = Guid.Parse((string)data.assetNamePrefix);

            string assetName = "Input-" + assetGuid.ToString();
            ...
            try
            {
                ...
                Asset assetParams = new Asset(null, assetName, null, assetGuid, DateTime.Now, DateTime.Now, assetGuid.ToString(), assetName, null, assetStorageAccount, AssetStorageEncryptionFormat.None);
